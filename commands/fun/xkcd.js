...
const xkcd=async(param,message)=>{
    ...
    else if(! isAllNumbers.test(param))
        return message.reply("Invalid xkcd number");
  ...
  catch(e){  msg.edit("An error occured(the number provided to the xkcd command might be out of range)"); }
}
